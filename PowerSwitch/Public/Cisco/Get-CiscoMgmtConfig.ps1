function Get-CiscoMgmtConfig {
    ...
    $VerbosePrefix = "Get-CiscoMgmtConfig:"
    ...
    :fileloop foreach ($entry in $LoopArray) {
        ...
        # no telnet-server
        $EvalParams.Regex = [regex] '^\ +transport\ input\ ssh'
        ...
        # web-managment
        $EvalParams.Regex = [regex] '^ip\ http\ server'
        $Eval = Get-RegexMatch @EvalParams
        if ($Eval) {
