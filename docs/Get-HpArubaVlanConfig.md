...
### path (Default)
```
Get-HpArubaVlanConfig [-ConfigPath] <String> [[-Ports] <Array>] [<CommonParameters>]
```

### array
```
Get-HpArubaVlanConfig [-ConfigArray] <Array> [[-Ports] <Array>] [<CommonParameters>]
```
